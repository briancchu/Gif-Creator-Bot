...
RUN apt-get update
RUN apt-get install -y --no-install-recommends ca-certificates gnupg build-essential libxi-dev libgl1-mesa-dev libglu1-mesa-dev libglew-dev pkg-config curl xvfb ffmpeg
RUN apt-get update
